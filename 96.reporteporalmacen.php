...
<br><br><br><br>
  <center><div class="card border-primary mb-3" style="max-width: 50rem;">
        <div class="card-header card text-white bg-primary mb-3">Generar Reporte Por Almacen</div>
         <div class="card-body text-primary">

           <center><form class="input form-reg" method="post"  action="97.reporteporalmacen.php">
            <br><br>
...
if($numReg>0){
  ...
  <select class="input form-control" name="almacen" placeholder="almacen"required value="">
    <option selected>Selecciona</option><br><br>
    <?php
