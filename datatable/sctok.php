...
return true;
     ...
     else
     {
       ...
       <center><div class="card border-primary mb-3" style="max-width: 80rem;">
        <div class="card-header card text-white bg-primary mb-3">Sctok</div>
...
<a href="288.eliminar_producto.php?id=<?php echo $id;?>"> 
               
          <button type= 'button' class= 'btn btn-danger' title="Eliminar" onclick="return Confirma()">&#x274e;</button>
 


          <a class="btn-submit btn btn-primary" title="Añadir" href="289.editar_producto.php?id=<?php echo $mostrar['id']; ?>">&#10133;</a>

          <a class="btn-submit btn btn-success" title="Disminuir"  href="801.editar_producto.php?id=<?php echo $mostrar['id']; ?>">&#9940;</a>

          


          
                <a href="#"  data-target="#my" class="edit" data-toggle="modal"
                  ...
                  <i class="btn btn-info" data-toggle="tooltip" title="Editar">&#x1f4dd;</i></a>
           ...
           <center>
            <form method="post"  action="281.modificar_productos_3.php">


                      Id
        <input class="input form-control" type="text" name="edit_id" readonly id="edit_id" placeholder="id"  value="" required ><br>Nombre<br>
        <input class="input form-control" type="text" name="edit_nom" id="edit_nom" placeholder="nombre" value="" required ><br>Marca<br>
        <input class="input form-control" type="text" name="edit_mar" id="edit_mar" placeholder="marca" value="" required ><br>Cantidad<br>
        <input class="input form-control" type="text" name="edit_cant" id="edit_cant" placeholder="cantidad" value="" required ><br>Fecha<br>
        <input class="input form-control" type="text" name="edit_fec" readonly id="edit_fec" placeholder="fecha" value="<?php echo date("d/m/Y"); ?>" required ><br>Almacen<br>
        <input class="input form-control" type="text" name="edit_alm" id="edit_alm" placeholder="almacen" value="" required ><br>Codigo<br>
        <input class="input form-control" type="text" name="edit_cod" id="edit_cod" placeholder="codigo" value="" required ><br>Tipo<br>
        <input class="input form-control" type="text" name="edit_tipo" id="edit_tipo" placeholder="tipo" value="Modificado" required ><br>Usuario<br>
